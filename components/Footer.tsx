...
export default function Footer() {
    return <footer className="bg-secondary dark:bg-secondary/20 text-neutral-100 transition-colors
    duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:col-span-2"> 
                    ...
                    font-heading text-primary mb-4
                  ">Areterex Fitness</h3>
                   <p className="mb-6 leading-relaxed max-w-md">
                    ...
                    <div className="flex space-x-4">
                        <Link href="https://www.instagram.com/trainedbysidd/" target="_blank" 
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        {navItems.map((link) => (
                            <li key={link.name}>
                                <Link href={link.href} className="hover:text-primary transition-colors duration-300">{link.name}</Link>
                            </li>
                        ))}
                    </ul>
                </div>
            ...
            <div className="border-t border-secondary/40 pt-20 text-center
            text-neutral-400">
                <p>
                    ©2025 Areterex Fitness. All rights reserved.
